...
//i sieć ta nie zawiera jeszcze krawędzi (slabel, tlabel), to dodaje krawędź
//(slabel, tlabel) do sieci, a w przeciwnym przypadu nic nie robi.
...
//Jeżeli istnieje sieć o identyfikatorze, a w niej węzeł o etykiecie label
//oraz sieć nie jest rosnąca, to usuwa węzeł z sieci wraz
//ze wszystkimi krawędziami wchodzącymi i wychodzącymi, a w przeciwnym przypadku nic nie robi.
...
//oraz sieć nie jest rosnąca, to usuwa krawędź z sieci, a w przeciwnym przypadku nic nie robi.
void network_remove_link(unsigned long id, const char* slabel, const char* tlabel);

//Jeżeli istnieje sieć o identyfikatorze id i sieć nie jest rosnąca,
//usuwa wszystkie jej węzły i krawędzie, a w przeciwnym przypadku nic nie robi.
